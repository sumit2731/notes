...
function Child() {
  ...
  React.useLayoutEffect(() => {
    console.log('%c Child: useLayoutEffect(() => {})', 'color: blue')
    return (() => {
      console.log(
...
function App() {
  ...
  React.useLayoutEffect(() => {
    console.log('%cApp: useLayoutEffect(() => {})', 'color: blue')
    return (() => {
      console.log(
  ...
  const element = (
    <>
      ...
      <button onClick={() => setRandomState(state => 1+state)}>Random State : {randomState}</button>
    </>
  )
