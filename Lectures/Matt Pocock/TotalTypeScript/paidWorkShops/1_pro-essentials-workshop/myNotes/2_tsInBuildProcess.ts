 ...
 *
 *      Why we have this "noEmit: true", this is bceuase because inside vite project,vite is now handling the
 *          actual bundling, turning ts code in js."noEmit: true", say to ts cli that we do not need you anymore or
 *          rather we do not need you to produce js files.questions is why we need ts complier at all? well vite
 ...
 *          convert yur code.while vite cli just converts your code into js which is lot easier than type checking.
 *
 ...
 *       process here.this is how it is used in most cases especially frontend projects.sometimes while working with node
