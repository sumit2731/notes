 ...
 *
 * Here it combines 3 union types and picks the properties common to them and excludes provided property
 * If we provide a property which does not exists then it just combines all common proeprties
