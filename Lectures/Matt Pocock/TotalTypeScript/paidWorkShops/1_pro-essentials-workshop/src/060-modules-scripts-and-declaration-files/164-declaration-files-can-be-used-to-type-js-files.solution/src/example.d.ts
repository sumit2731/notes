 ...
 *
 * So this is a really nice way to basically describe JavaScript files in your project that, for instance,
 * maybe were auto-generated by script or, let's say, haven't been migrated across the TypeScript yet.
 * And what we'll see is that this pattern is basically how you ship JavaScript files in NPM while still
 * having them be compatible with your TypeScript project.so these are 2 use cases for making a declaration
 * file a module
 *
 */
 ...
 *   be script. so do not use any import/export. also everything in in all dcelartions should start
 *   with export or declare, so if you are making global declarations in script then they should start
 *   with declare.
 *
