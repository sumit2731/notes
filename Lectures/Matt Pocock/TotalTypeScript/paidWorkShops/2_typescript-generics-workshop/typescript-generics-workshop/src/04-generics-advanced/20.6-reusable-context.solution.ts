...
/**
 * You can imagine now that useStyled and MyTheme can sit in one
 * module together, and they can export useStyled, and then buttonStyle and
 * divStyle can just consume from useStyled here without needing to pass in a
 * type argument.
 *
 *
 * his solution is really, really useful, and I wish more libraries did it. It lets you pass
