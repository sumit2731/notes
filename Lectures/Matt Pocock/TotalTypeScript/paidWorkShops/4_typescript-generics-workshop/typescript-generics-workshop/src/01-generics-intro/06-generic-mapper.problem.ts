...
/**
 * a)Make sure that first argument to function has firstName and lastName properties
 * b)Thing that is returned from function contains all properties passed in plus extra fullName property
 */
