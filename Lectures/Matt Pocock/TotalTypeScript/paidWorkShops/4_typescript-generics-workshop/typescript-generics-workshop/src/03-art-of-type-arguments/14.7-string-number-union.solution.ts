...
/**
 * This is a neat little trick that you can pick up when you want to accept 
 * multiple things into an identity function, or into a generic slot and you
 * want them to be inferred to their literals. 
 */
