...
describe("Newsletter", () => {
  ...
  it("should dislay a success message", () => {
    ...
    /**
     * we can also save the intercepted api call in a alias so that later we can wait to get response from this api call before going ahead with test
     *
     ...
     *
     *
     * see this link to understand how you can wait for request multiple times -
