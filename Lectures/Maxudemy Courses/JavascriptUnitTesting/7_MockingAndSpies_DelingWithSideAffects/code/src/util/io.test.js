 ...
 * a third party code is doing this. also we do not need to have unintended side affects like writing to file system, writing to db,
 * making http calls
 */
...
it("should execute writeFile method", () => {
  ...
  /**
   * This will now fail function of fs module are replaced by spies. they do not return promise.
   * Infact they do not return anything
   */
  //expect(writeData(testData,testFileName)).resolves.toBeUndefined();
