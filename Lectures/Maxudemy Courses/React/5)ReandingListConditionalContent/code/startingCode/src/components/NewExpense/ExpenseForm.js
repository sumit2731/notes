...
const ExpenseForm = (props) => {
    ...
    /**
     * @Desc Single State Approach - used to demonstate cases where we use previous state to update curent state.
     *  there we need use callback based approach
     */
