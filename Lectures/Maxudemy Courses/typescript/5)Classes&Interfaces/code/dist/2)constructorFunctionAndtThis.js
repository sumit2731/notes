...
var Department2 = /** @class */ (function () {
    ...
    *we use just name,then it would look for a variable name which has to exist
    ...
    here we wnt get error forname because there actually is global variable in
    browser in window object
    */
...
var accountingCopy2 = { describe: accounting2.describe };
/*
...
'this'(it what 'this' inside funtion should refer to) should refer to, now its important to asign a
...
based on Department Class, so an Object which in the endshould be of type Department.
...
*/ 
//# sourceMappingURL=2)constructorFunctionAndtThis.js.map