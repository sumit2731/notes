 ...
 *
 * also see comments in src/components/Header.tsx about using custom hook to access context
 * instead of using useContext. Also see how to tell that return type from a function is not
 * null
 */
