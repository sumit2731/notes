...
public class StreamsDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /**
         * Sream has methods in which you can set operators, you can say i have assembly
         * line, i want certain things, to do operation on each elemnt of steram
         * 
         * eaist way to do operation on every element of string is by calling forEach
         * method. It takes cosnumer as argument
         * 
         * This is equivalent of adding a worker to assembly line.
         * when you created the stream, run time setsup the assembly line and tells ,
         ...
         * assembly line.we added one worker, forEach is special type of wrker which
        ...
        /**
         * first argis seed second is unary operator.
